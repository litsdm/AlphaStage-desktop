...
export default class MenuBuilder {
  ...
  buildDarwinTemplate() {
    const subMenuAbout = {
      label: 'Alpha Stage',
      submenu: [
        { label: 'About Alpha Stage', selector: 'orderFrontStandardAboutPanel:' },
        { type: 'separator' },
  ...
  buildDefaultTemplate() {
    const templateDefault = [{
      ...
      submenu: [{
        label: 'Learn More',
        click() {
          shell.openExternal('http://alphastagegames.com');
        }
      }, {
        label: 'Documentation',
        click() {
          shell.openExternal('https://github.com/cdiezmoran/AlphaStage-desktop');
        }
      }, {
        label: 'Search Issues',
        click() {
          shell.openExternal('https://github.com/cdiezmoran/AlphaStage-desktop/issues');
        }
      }]
    }];
